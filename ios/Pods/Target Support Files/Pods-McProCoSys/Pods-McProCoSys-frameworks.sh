...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RCTRestart/RCTRestart.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNFBDatabase/RNFBDatabase.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RNFS/RNFS.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RNFileViewer/RNFileViewer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ReactCommon-turbomodule_core-turbomodule_samples/ReactCommon.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ReactNativeExceptionHandler/ReactNativeExceptionHandler.framework"
